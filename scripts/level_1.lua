...
add_ai_player_start_info(2, {M_SPELL_BLAST, M_SPELL_CONVERT_WILD}, {M_BUILDING_TEPEE, M_BUILDING_DRUM_TOWER, M_BUILDING_WARRIOR_TRAIN, M_BUILDING_SUPER_WARRIOR_TRAIN});
